...
def run_capital_mv_min_variancia_tecnicas(
    weights_folder="./data/tecnicas/mv_min_variancia_tecnicas_9/",
    targets_folder="./data/tecnicas/targets_por_tecnica_tecnicas_6/",
    output_folder="./data/tecnicas/capital_mv_min_variancia_tecnicas_11/",
    ...
    run_capital_mv_tecnicas(
        ...
        metodo="min_variancia",
        capital_inicial=capital_inicial,
        dias_max_posicao=dias_max_posicao,
    )

    print("\nDistribuicao de capital MV Min Variancia por tecnicas concluida.")
